 ...
 *
 * Written outputs:
 *   • `apps/landing/src/generated/counts.ts` — committed for direct imports.
 *   • `apps/storybook/stories/_data/counts.generated.ts` — gitignored and
 *     regenerated by the landing, Storybook, and root-test commands.
 *
 * `src/claims.spec.ts` is what keeps both projections honest.
 *

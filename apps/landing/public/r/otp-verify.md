...
A one-time-code card: a 6-digit DzOtpInput, a Verify button that enables once the code is complete, a live resend countdown, and a success state on completion.

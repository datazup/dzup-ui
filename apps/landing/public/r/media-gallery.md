...
An asymmetric image grid where every ratio-stable DzImage tile (framed by DzAspectRatio) opens a focus-trapped DzLightbox with captions, a counter, and arrow-key navigation.

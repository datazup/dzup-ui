...
A reservation card pairing the date/time/number controls — a DzDatePicker day, a 30-minute-step DzTimePicker slot, a clamped DzNumberInput party size, and a seating DzSelect.

...
A "danger zone" panel pairing the two confirmation patterns — heavy actions route through a modal DzConfirmDialog (the delete simulates an async, loading confirm) while low-risk row deletes use an inline DzPopconfirm bubble.

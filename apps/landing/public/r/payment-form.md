...
A checkout card showcasing masked and grouped inputs: DzInputMask formats the card number and expiry as you type, and a DzInputGroup pairs a promo field with an inline Apply button.

...
A document toolbar built from the Buttons family — toggle buttons for inline format and alignment, icon-button history/insert actions, a copy-link button, and a split "Publish" action. Toggles are live.

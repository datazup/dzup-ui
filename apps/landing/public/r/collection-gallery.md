...
A DzDataView template marketplace with a list/grid layout toggle, client-side sorting and a paginator; the #item slot renders rich cards in grid mode and compact rows in list mode from the same records.

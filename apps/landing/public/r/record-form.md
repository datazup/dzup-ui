...
A "create issue" panel built from the selection inputs — a searchable DzCombobox assignee, a DzMultiSelect labels picker, a single-select DzListbox priority, plus title and description fields.

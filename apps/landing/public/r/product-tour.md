...
A spotlight onboarding walkthrough (DzTour) over a mini dashboard — "Start tour" dims the page, spotlights each target in turn, and shows an anchored step popover with Back/Next/Finish controls and progress dots.

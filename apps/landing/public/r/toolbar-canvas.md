# Toolbar canvas shell

A design-tool shell — a DzToolbar with start/center/end regions over a vertical DzFlex tool rail (a DzSpacer pushing settings to the bottom), a scrollable DzScrollArea artboard, and a DzPanel inspector with DzDivider-fenced groups.

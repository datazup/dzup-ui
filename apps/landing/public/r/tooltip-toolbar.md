...
A formatting toolbar where every DzIconButton is wrapped in a DzTooltip revealing its name and DzKbd shortcut on hover/focus — demonstrating per-side placement and a short open delay, with DzDivider-fenced groups.

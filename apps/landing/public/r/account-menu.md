...
A product top bar with a rich DzDropdownMenu account menu — avatar trigger, an account header, icon-prefixed items with DzKbd shortcut suffixes, separators, and a destructive sign-out.

...
A broad account panel: a file-upload avatar drop zone, name/username inputs, a role select, a bio textarea with counter, a free-text skills tags input, and a public-profile switch.

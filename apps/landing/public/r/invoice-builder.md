...
A dynamic line-items editor — a DzInplace click-to-edit "Bill to" field over a DzFieldArray of removable description/qty/rate rows, an "Add line item" action, and a live total.

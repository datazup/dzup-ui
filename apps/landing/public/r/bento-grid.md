...
A spanning "bento box" dashboard laid out with DzGrid — a 2×2 revenue hero, a fixed-ratio media tile, compact stat panels and a full-width footer cell, all collapsing to a single column on mobile.

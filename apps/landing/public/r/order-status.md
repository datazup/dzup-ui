...
A fulfilment timeline for a single order — a DzStepper rail from placed to delivered marking the parcel’s current stage, a tone-coded status badge, and a carrier / tracking / ETA detail grid; the rail turns vertical on mobile.

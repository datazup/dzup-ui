...
An editable cart — a divided list of line items each with a thumbnail, a clamped quantity stepper and a remove action, plus live subtotal/shipping/tax/total rows and a checkout button.

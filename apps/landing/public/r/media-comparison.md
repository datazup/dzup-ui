...
A draggable, keyboard-operable DzImageComparison revealing a graded edit over the raw frame, with before/after label chips and a live reveal read-out wired to v-model:position.

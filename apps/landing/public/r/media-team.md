...
A stacked DzAvatarGroup with a "+N" overflow chip over a member list, each row pairing a DzAvatar (image or initials fallback) with a presence dot and an online/away DzBadge.

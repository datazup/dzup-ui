...
A sharing / permissions panel — a searchable DzTransfer dual-list of capabilities, a DzPersonaSelector owner picker (avatar + name + role), and a DzMention note with @-mentions.

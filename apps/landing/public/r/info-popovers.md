...
Two DzPopover patterns side by side — a profile hover card (avatar, bio, follow action) and a non-modal filter panel with DzSwitch rows and apply/reset — each with an arrow and explicit side/alignment.

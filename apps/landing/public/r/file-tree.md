...
A hierarchical DzTree with per-node lucide icons, expand/collapse and selection (both v-modelled) and the full APG roving-tabindex keyboard model, beside a live selection panel.

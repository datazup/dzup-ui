...
A two-state reset-request card — a validated email field (inline error via DzFormMessage) that swaps to a "check your inbox" confirmation with resend and back-to-sign-in actions.

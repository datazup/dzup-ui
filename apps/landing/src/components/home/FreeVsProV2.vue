...
import { DzGradientText, vTilt } from '../../motion/index.ts'
import Section from '../Section.vue'

// FreeVsProV2 (docs/landing-v2.md TASK-LV2-08) — the v1 fork section (which
// /classic keeps) with physical plan cards: both tilt toward a fine pointer
// (v-tilt + glare, resting state for touch/reduced motion) and the Pro card's
// heading carries the panning DzGradientText. All copy and both inventories
// are v1's, verbatim:
//
...
<template>
  ...
  >
    <template #default>
      ...
      <div class="fork-grid">
        <article v-tilt="{ max: 5, perspective: 1200, glare: true }" class="lp-card plan">
        ...
        <article v-tilt="{ max: 5, perspective: 1200, glare: true }" class="lp-card plan plan--pro">
          ...
          <DzHeading :level="3" size="lg" weight="semibold" class="plan-title">
            <DzGradientText>Go Pro</DzGradientText>
          </DzHeading>
          <DzText size="sm" tone="muted">

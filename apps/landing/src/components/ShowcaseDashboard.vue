...
// A real, composed dashboard built entirely from @dzup-ui/core (spec §4.3).
// It re-themes live with the toggle — the headline "show, don't tell" proof.
const query = ref('')
...
<template>
  <Section
    ...
    title="Built from the library itself"
    lede="Every element below is a live @dzup-ui/core component. Toggle the theme — the whole surface re-skins from one token system."
    heading-id="showcase-title"
  >
    <div class="frame-wrap">
      <div class="frame-glow" aria-hidden="true" />
      <div class="window" role="img" aria-label="Example analytics dashboard built with dzup-ui">

...
Of those, **441 are `unrun`** — nothing has measured them — and **40 are `stale`**. Which cells, on which components, is on [the capability matrix](/evidence/capability-matrix) and on each component page.

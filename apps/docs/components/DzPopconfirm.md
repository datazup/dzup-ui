...
| --- | --- | --- | --- |
| Props | 15 | 15 | 4 declare a default, of which 8 declare `undefined` (ADR-20 provider supplies the value) |
...
**6 unrun:** `axe`, `ssr-sample`, `keyboard-spec`, `controlled-uncontrolled`, `portal-hydration`, `at-manual` · **1 stale:** `browser-matrix`. They are named rather than counted, because a total tells a reader nothing about what is missing.

---
title: "DzCheckboxGroup"
description: "Groups DzCheckbox components with a shared string[] model."
outline: [2, 3]
---
...
Groups DzCheckbox components with a shared string[] model.

- **Family:** Forms
- **Source:** `packages/core/src/components/forms/DzCheckboxGroup.vue` · types `packages/core/src/components/forms/DzCheckboxGroup.types.ts`
- **Install:** `npm i @dzup-ui/core` — then `import { DzCheckboxGroup } from '@dzup-ui/core'`
...
| --- | --- | --- |
| `default` | — | Child DzCheckbox components |

## Usage (from `packages/core/stories/forms/DzCheckboxGroup.stories.ts`, story `Default`)
...
Editable, running the **Size Gallery** story from `packages/core/stories/forms/DzCheckboxGroup.stories.ts` (lines 104–121) **verbatim**. Edits run in a sandbox; nothing here is saved.
...
Record: `e2e/at-matrix/DzCheckboxGroup.md` (append-only). No executable script exists for this component yet; scripts were authored for the Tier C and D components first.

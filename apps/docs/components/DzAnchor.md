...
`DzAnchor` advertises 2 states:
`active`, `ready`. Each is emitted as `data-state` or as a
...
| --- | --- | --- | --- |
| Props | 10 | 10 | 3 declare a default, of which 5 declare `undefined` (ADR-20 provider supplies the value) |

...
| --- | --- | --- | --- |
| Props | 13 | 13 | 6 declare a default, of which 5 declare `undefined` (ADR-20 provider supplies the value) |
...
| `ssr-sample` | tier A | `present` | `packages/core/tests/ssr/dz-provider-ssr.spec.ts` · `packages/core/tests/ssr/ssr-smoke.spec.ts` |

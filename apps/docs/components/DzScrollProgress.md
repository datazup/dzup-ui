---
title: "DzScrollProgress"
description: "Scroll-position progress indicator."
outline: [2, 3]
---
...
Scroll-position progress indicator.

- **Family:** Feedback
- **Source:** `packages/core/src/components/feedback/DzScrollProgress.vue` · types `packages/core/src/components/feedback/DzScrollProgress.types.ts`
- **Install:** `npm i @dzup-ui/core` — then `import { DzScrollProgress } from '@dzup-ui/core'`
...
## Props (10, of which 3 inherited from `@dzup-ui/contracts`)
...
| `ariaLabel` | `string \| undefined` | no | `undefined` | Accessible label for the progress indicator. Defaults to `'Page scroll progress'`. |
...
| --- | --- | --- |
| `change` | `[value: number]` | Fired with the clamped 0–100 progress value whenever it changes. |

## Slots (1)

| Slot | Slot props | Description |
| --- | --- | --- |
| `default` | `{ value: number; }` | Replaces the default bar/ring with custom UI. Receives the clamped 0–100 progress value. |

## Usage (verbatim story source from `packages/core/stories/feedback/DzScrollProgress.stories.ts`, story `TopBar`)
...
| --- | --- | --- | --- |
| Props | 10 | 10 | 1 declare a default, of which 6 declare `undefined` (ADR-20 provider supplies the value) |
...
| --- | --- | --- | --- |
| `contract-spec` | tier A | `present` | `packages/core/src/components/feedback/DzScrollProgress.contract.spec.ts` |
| `unit-spec` | tier A | `present` | `packages/core/src/components/feedback/DzScrollProgress.spec.ts` |
| `axe` | tier A | **`unrun`** | — |
| `story-light-dark` | tier A | `pass` | `packages/core/stories/feedback/DzScrollProgress.stories.ts` |

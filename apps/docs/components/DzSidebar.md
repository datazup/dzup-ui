...
`DzSidebar` advertises 5 states:
`active`, `collapsed`, `expanded`, `inactive`, `url-rejected`. Each is emitted as `data-state` or as a
...
| --- | --- | --- | --- |
| Props | 15 | 15 | 5 declare a default, of which 8 declare `undefined` (ADR-20 provider supplies the value) |
...
- **APG pattern:** [`landmarks`](https://www.w3.org/WAI/ARIA/apg/patterns/landmarks/)
...
- **Pattern:** [APG — `landmarks`](https://www.w3.org/WAI/ARIA/apg/patterns/landmarks/) · its *Keyboard Interaction* section is

/**
 * DzSearchInput -- Component-specific token mappings.
 * Maps semantic design tokens to component styling (ADR-04).
 *
 * Reuses DzInput wrapper/element variants and adds search-specific
 * icon and clear button token references.
 */
export const searchInputTokens = {
  ...
  /** Search icon color */
  iconColor: 'var(--dz-colors-neutral-400)',
  /** Clear button */
  clearButton: {

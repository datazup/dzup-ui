...
export const inputWrapperVariants = tv({
  base: [
    ...
    'focus-within:outline-none focus-within:ring-[length:var(--dz-input-focus-ring-width)] focus-within:ring-[var(--dz-input-focus-ring-color)] focus-within:ring-offset-[var(--dz-input-focus-ring-offset)]',

/**
 * DzNumberInput -- Component-specific token mappings.
 * Maps semantic design tokens to component styling (ADR-04).
 *
 * Reuses DzInput wrapper and element variants, adding
 * stepper button token references.
 */
export const numberInputTokens = {
  /** Background for the outline variant (inherited from input tier) */
  ...
  stepper: {
    color: 'var(--dz-colors-neutral-500)',

 ...
 *
 * @module @dzip-ui/core/components/forms/DzMultiSelect.variants
 */
...
export const multiSelectVariants = tv({
  ...
  variants: {
    ...
    size: {
      ...
      lg: {
        root: 'min-h-[var(--dz-button-lg-height)] px-[var(--dz-spacing-4)] py-[var(--dz-spacing-1)] text-[length:var(--dz-text-base)]',

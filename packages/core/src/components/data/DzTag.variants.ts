...
export const tagVariants = tv({
  ...
  compoundVariants: [
    ...
    },
    {
      variant: 'solid',
      tone: 'neutral',
      class: 'bg-[var(--dz-foreground)] text-[var(--dz-background)]',
    },
    {
      variant: 'solid',
      tone: 'success',
      class: 'bg-[var(--dz-success)] text-[var(--dz-success-foreground)]',
    },
    {
      variant: 'solid',
      tone: 'warning',
      class: 'bg-[var(--dz-warning)] text-[var(--dz-warning-foreground)]',
    },
    {
      variant: 'solid',
      tone: 'danger',
      class: 'bg-[var(--dz-danger)] text-[var(--dz-danger-foreground)]',
    },
    {
      variant: 'solid',
      tone: 'info',
      class: 'bg-[var(--dz-info)] text-[var(--dz-info-foreground)]',
    },

...
- **Components:** 208 across 11 families — counted as every exported `.vue` component, including compound sub-parts such as `DzCardBody`
...
This file is deliberately **high-level**. For the full catalog — 208 components (138 with a dedicated docs page), 87 blocks, 44 full-page templates,

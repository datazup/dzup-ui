...
# DzFileUpload — manual AT task matrix
...
| `voiceover-ios` | **required** | VoiceOver + Safari (iOS) | Touch exploration; a control reached by gesture, not by Tab. |
| `talkback-android` | **required** | TalkBack + Chrome (Android) | Touch exploration, gestures and drag alternatives. |

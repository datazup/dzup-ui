...
> Generated 2026-09-21T14:35:43.943Z by `release:api-diff`.
...
| Kind | Symbol | Severity | Level | Detail |
|---|---|---|---|---|
| unbaselined | `26 symbol(s)` | none | none | no baseline of any kind exists for this package — nothing has been published and no snapshot has been recorded. The surface is reported, not diffed. |
